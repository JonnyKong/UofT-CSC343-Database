...
SELECT w.country_id, w.cabinet_id AS cabinetId, w.start_date AS startDate, w.endDate, p.name
...
FROM with_end_time w1 LEFT JOIN with_party_name_not_null w2 ON w1.cabinet_id = w2.cabinetId ;
